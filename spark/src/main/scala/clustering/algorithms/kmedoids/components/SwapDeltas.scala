...
import clustering.algorithms.kmedoids.local.PAM
 ...
 *
 *  Derivation and why [[PAM]] deliberately does not use it: `docs/kmedoids_docs.md`.
 */
private[kmedoids] object SwapDeltas {
  ...
  /** Best move for `candidate`, or [[SwapMove.None]] if no slot improves. */
